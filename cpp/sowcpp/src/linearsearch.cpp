//an example of a linear array search program
//found on page 452 of the book
#include <iostream>
using namespace std;
...
// The array list, which has a max of numElems elements, is searched for the number
