/*
 * Exercise 4-4 
 * Add functions to examine the top two elements of the stack without 
 * pop()-ing them, as well as a function to swap the top two elements of 
 * the stack, and a command to clear the stack. 
 *
 * I'm not sure what value these exercises in particular have outside 
 * of general stack manipulation, but it'll be useful practice.
 *
